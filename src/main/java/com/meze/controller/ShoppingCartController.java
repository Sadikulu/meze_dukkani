...
public class ShoppingCartController {
    ...
    @PostMapping
    public ResponseEntity <GPMResponse> createCartItem(@RequestHeader("cartUUID") String cartUUID,@RequestBody ShoppingCartRequest shoppingCartRequest) {
            ShoppingCartItemDTO shoppingCartItemDTO = shoppingCartService.createCartItem(cartUUID,shoppingCartRequest);
            GPMResponse gpmResponse = new GPMResponse(ResponseMessage.ITEM_ADDED_RESPONSE_MESSAGE,true,shoppingCartItemDTO);
    ...
    public ResponseEntity<GPMResponse> deleteCartItem(@RequestHeader("cartUUID") String cartUUID,@PathVariable("productId") Long productId) {
        ...
        GPMResponse gpmResponse = new GPMResponse(ResponseMessage.CART_ITEM_DELETED_RESPONSE_MESSAGE, true, shoppingCartItemDTO);
